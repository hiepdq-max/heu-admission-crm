                  ...
                  >
                    ...
                    <div className="mt-4 grid gap-3 rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-950 lg:grid-cols-[minmax(0,1fr)_minmax(16rem,24rem)]">
                      <label className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <span className="mt-1 block text-xs leading-5 text-amber-800">
                            Chi xac nhan sau khi owner da duyet qua kenh an toan
                            ngoai Git/Codex/chat. Checkbox nay khong thay the
                            chu ky duyet.
                          </span>
                        </span>
                      </label>
                      ...
                      <label className="text-xs font-semibold uppercase text-amber-900">
                        Ma evidence scope da kiem soat
                        <input
                          type="text"
                          name="scope_controlled_evidence_id"
                          required
                          pattern="CE-SCOPE-[A-Za-z0-9][A-Za-z0-9._:-]{5,63}"
                          minLength={14}
                          maxLength={72}
                          autoComplete="off"
                          spellCheck={false}
                        ...
                        <span className="mt-1 block text-xs font-normal normal-case leading-5 text-amber-800">
                          Use a safe redacted reference only. Chi nhap ma
                          CE-SCOPE da an danh. Khong nhap email, so dien thoai,
                          CCCD, token, mat khau hoac du lieu tho.
                        </span>
                      </label>
                    </div>
