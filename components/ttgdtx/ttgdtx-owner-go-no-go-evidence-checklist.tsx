...
const evidenceItems: EvidenceItem[] = [
  ...
  {
    caseId: "P0-09-04",
    title: "Lead handover, payout and dashboard UAT accepted",
    owner: "TUYEN_SINH + CTHSSV + DAO_TAO + KHTC + BGH + Audit + IT_DATA",
    evidence:
      "P3-01/P3-02 lead lifecycle and handover UAT from HEU_LEAD_LIFECYCLE_HANDOVER_UAT_RUNBOOK_20260628.md, P2-17 duplicate-payout UAT and P2-18 read-only dashboard reconciliation signed by required owners.",
  },
  {
    caseId: "P0-09-05",
...
const ownerGoNoGoAcceptanceItems: OwnerGoNoGoAcceptanceItem[] = [
  ...
  },
  {
    ...
    minimum:
      "P0-19, P3-01/P3-02 lifecycle and handover UAT, P2-17, P2-18, role/workspace UAT, P0-17 access closure decision, audit-log trace rows and UAT operator handoff are signed; HEU_LEAD_LIFECYCLE_HANDOVER_UAT_RUNBOOK_20260628.md and HEU_NON_TTGDTX_CASCADE_FINDING_REGISTER_20260628.md are cited; every unresolved P6-06 finding is converted or narrowly waived in writing.",
    stopCondition:
...
const ownerGoNoGoDecisionItems: OwnerGoNoGoDecisionItem[] = [
  ...
  },
  {
    ...
    requiredDecision:
      "Owner decision cites signed P3-01/P3-02 lifecycle and handover UAT, P2-17 payout UAT, P2-18 dashboard UAT, P5-03 Finance Desk UAT and UAT operator handoff closure.",
    stopCondition:
      "Any unsigned browser UAT, missing P3 handover closure, P3 handover bypass of P0-19/P2-05/P2-03, duplicate payout risk, dashboard write path, unreconciled total or missing handoff closure keeps NO_GO.",
  },
  {
    caseId: "P0-09-DEC-05",
