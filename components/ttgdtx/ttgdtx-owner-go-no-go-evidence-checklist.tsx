...
const ownerGoNoGoAcceptanceItems: OwnerGoNoGoAcceptanceItem[] = [
  ...
  },
  {
    ...
    minimum:
      "P0-19, P3-01/P3-02 lifecycle and handover UAT, P2-17, P2-18, role/workspace UAT, audit-log trace rows and UAT operator handoff are signed; HEU_LEAD_LIFECYCLE_HANDOVER_UAT_RUNBOOK_20260628.md and HEU_NON_TTGDTX_CASCADE_FINDING_REGISTER_20260628.md are cited; every unresolved P6-06 finding is converted or narrowly waived in writing.",
    stopCondition:
