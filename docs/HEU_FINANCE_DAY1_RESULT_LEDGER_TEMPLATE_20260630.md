...
| Evidence ID | Account label | Owner | Profile/scope | Route | Expected result | Actual result | Owner decision | Access closure | Sign-off state |
|---|---|---|---|---|---|---|---|---|---|
| `FIN-DAY1-EVID-001` | `REAL_KHTC_TTGDTX_OPERATOR_01` | KHTC + IT_DATA | Role/department/segment/TTGDTX partner-workspace label | P6-04 / P2-18 / P5-03 / P2-17 / P0-17 | `ALLOWED` only inside assigned finance scope | Redacted evidence reference only | `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` | `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` | Operator + checker + owner + redaction reviewer |
| `FIN-DAY1-EVID-002` | `REAL_BGH_READONLY_01` | BGH + IT_DATA | Role/department/segment/TTGDTX partner-workspace label | P6-04 / P2-18 / P5-03 / P0-17 | `READ_ONLY` | Redacted evidence reference only | `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` | `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` | Operator + checker + owner + redaction reviewer |
| `FIN-DAY1-EVID-003` | `REAL_AUDIT_READONLY_01` | Audit + IT_DATA | Role/department/segment/TTGDTX partner-workspace label | P6-04 / audit/evidence review / P0-17 | `READ_ONLY` | Redacted evidence reference only | `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` | `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` | Operator + checker + owner + redaction reviewer |
| `FIN-DAY1-EVID-004` | `REAL_PHAP_CHE_REVIEW_01` | PHAP_CHE + IT_DATA | Role/department/segment/TTGDTX partner-workspace label | P6-04 / legal-source review / P0-17 | `LEGAL_REVIEW_ONLY` | Redacted evidence reference only | `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` | `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` | Operator + checker + owner + redaction reviewer |
| `FIN-DAY1-EVID-005` | `REAL_OUT_OF_SCOPE_NEGATIVE_01` | IT_DATA + Audit | Negative-control label only | P6-04 / blocked route checks / P0-17 | `BLOCKED` or `EMPTY_SCOPED_STATE` | Redacted evidence reference only | `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` | `BLOCKED` or `REVOKE_OR_REDUCE` | Operator + checker + owner + redaction reviewer |
