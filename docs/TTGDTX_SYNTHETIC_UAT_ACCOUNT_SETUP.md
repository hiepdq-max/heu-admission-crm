...
temporary passwords, password reset links, account activation/invite links or
...
- Do not send real passwords, temporary passwords, password reset links or
  account activation/invite links into Codex/chat.
...
2. Set temporary UAT-only passwords in the password manager controlled by
   IT/Data. Do not paste those passwords, password reset links or account
