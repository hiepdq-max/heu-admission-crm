...
| P0-10-ACCEPT-03 | Redaction preserves proof while removing private data | Names, CCCD/passport, phone, bank account, credentials, temporary passwords, password reset links, account activation/invite links, vouchers and raw payment data are masked or removed | The redacted copy leaks private data or no longer proves the intended control |
