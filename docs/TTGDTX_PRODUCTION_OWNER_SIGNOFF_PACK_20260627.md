...
| P5-03 Finance Desk controlled trial and UAT | KHTC + BGH + IT_DATA + Audit | `docs/HEU_FINANCE_DESK_UAT_RUNBOOK_20260627.md`, `docs/HEU_FINANCE_DESK_CONTROLLED_TRIAL_PLAN_20260630.md`, `docs/HEU_FINANCE_DAY1_START_GATE_CHECKLIST_20260630.md`, `docs/HEU_FINANCE_DAY1_RESULT_LEDGER_TEMPLATE_20260630.md`, P5-03-TRIAL-EVID-001 through P5-03-TRIAL-EVID-005, FIN-START-EVID-001 through FIN-START-EVID-005, FIN-DAY1-EVID-001 through FIN-DAY1-EVID-005, `P5_03_CONTROLLED_TRIAL_READY / NO_GO / BLOCKED`, `FIN_START_READY / NO_GO / BLOCKED`, `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED`, `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` and read-only reliance decision | NO-GO |
...
| Finance Day-1 start-gate checklist, result ledger and access closure result |  |  | PENDING |
...
| P0-09-04 | TUYEN_SINH + CTHSSV + DAO_TAO + KHTC + BGH + Audit + IT_DATA | Signed P3-01/P3-02 lead lifecycle and handover UAT, P2-17 duplicate-payout UAT, P2-18 read-only dashboard reconciliation, P5-03 Finance Desk UAT, P5-03-TRIAL-EVID-001 through P5-03-TRIAL-EVID-005 from `docs/HEU_FINANCE_DESK_CONTROLLED_TRIAL_PLAN_20260630.md`, FIN-START-EVID-001 through FIN-START-EVID-005 from `docs/HEU_FINANCE_DAY1_START_GATE_CHECKLIST_20260630.md` with `FIN_START_READY / NO_GO / BLOCKED`, and FIN-DAY1-EVID-001 through FIN-DAY1-EVID-005 from `docs/HEU_FINANCE_DAY1_RESULT_LEDGER_TEMPLATE_20260630.md` with `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` and `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` | NO-GO |
...
| P0-09-ACCEPT-03 | Finance, legal and UAT blockers closed | P0-19, P3-01/P3-02 lifecycle and handover UAT, P2-17, P2-18, P5-03 Finance Desk controlled trial, role/workspace UAT, P0-17 access closure decision, audit-log trace rows and UAT operator handoff are signed; `docs/HEU_LEAD_LIFECYCLE_HANDOVER_UAT_RUNBOOK_20260628.md`, `docs/HEU_FINANCE_DESK_CONTROLLED_TRIAL_PLAN_20260630.md`, `docs/HEU_FINANCE_DAY1_START_GATE_CHECKLIST_20260630.md`, `docs/HEU_FINANCE_DAY1_RESULT_LEDGER_TEMPLATE_20260630.md` and `docs/HEU_NON_TTGDTX_CASCADE_FINDING_REGISTER_20260628.md` are cited; P5-03-TRIAL-EVID-001 through P5-03-TRIAL-EVID-005, FIN-START-EVID-001 through FIN-START-EVID-005, FIN-DAY1-EVID-001 through FIN-DAY1-EVID-005, `P5_03_CONTROLLED_TRIAL_READY / NO_GO / BLOCKED`, `FIN_START_READY / NO_GO / BLOCKED`, `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` and `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` are recorded; every unresolved P6-06 finding is converted or narrowly waived in writing | Any UAT/waiver is unsigned, any HIGH/BLOCKER exception remains, P3-01/P3-02 is unsigned, leaks role/workspace scope or lets handover bypass P0-19/P2-05/P2-03 finance gates, P2-17 can pay twice, P2-18 can write or cannot reconcile, P5-03 controlled-trial evidence is missing, Finance Day-1 start-gate checklist is missing, Finance Day-1 result ledger is missing, access-retain/revoke/block decision is missing, role leak exists, P0-17 access closure is missing, audit trace is incomplete or a P6-06 finding lacks conversion/waiver decision |
...
| P0-09-DEC-04 | UAT and operating proof decision | Owner decision cites signed P3-01/P3-02 lifecycle and handover UAT, P2-17 payout UAT, P2-18 dashboard UAT, P5-03 Finance Desk UAT, P5-03-TRIAL-EVID-001 through P5-03-TRIAL-EVID-005, FIN-START-EVID-001 through FIN-START-EVID-005, FIN-DAY1-EVID-001 through FIN-DAY1-EVID-005, `docs/HEU_FINANCE_DAY1_START_GATE_CHECKLIST_20260630.md`, `docs/HEU_FINANCE_DAY1_RESULT_LEDGER_TEMPLATE_20260630.md`, `P5_03_CONTROLLED_TRIAL_READY / NO_GO / BLOCKED`, `FIN_START_READY / NO_GO / BLOCKED`, `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED`, `ACCESS_RETAIN / REVOKE_OR_REDUCE / BLOCKED` and UAT operator handoff closure | Any unsigned browser UAT, missing P3 handover closure, P3 handover bypass of P0-19/P2-05/P2-03, duplicate payout risk, dashboard write path, missing P5-03 controlled-trial evidence, missing Finance Day-1 start-gate checklist, missing Finance Day-1 result ledger, missing access-retain/revoke/block decision, unreconciled total or missing handoff closure keeps NO_GO |
...
8. P5-03 Finance Desk controlled-trial evidence is missing, unsigned,
   uncontrolled, lacks Finance Day-1 start-gate checklist proof or lacks
   `P5_03_CONTROLLED_TRIAL_READY / NO_GO / BLOCKED`,
   `FIN_START_READY / NO_GO / BLOCKED`,
   `FIN_DAY1_RESULT_READY / NO_GO / BLOCKED` or
