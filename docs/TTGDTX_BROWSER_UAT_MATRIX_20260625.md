...
Do not send real passwords, temporary passwords, password reset links or account
activation/invite links into Codex/chat. Do not use real student, bank or staff
