...
| P5-03 | HEU Finance Desk read-only cockpit | KHTC + BGH + IT/Data | PASS_LOCAL | `app/finance-desk/page.tsx`; `database/step111_heu_finance_desk.sql`; `docs/modules/HEU_FINANCE_DESK_MVP_SPEC_20260627.md`; `docs/HEU_FINANCE_DESK_UAT_RUNBOOK_20260627.md`; `npm.cmd run audit:heu-finance-desk`; Finance Desk uses permission/workspace-scope gate, read-only TTGDTX views, shared VND formatting, UAT acceptance matrix and P5-03 reliance decision manifest; signed finance/dashboard UAT and reliance decision still required |
