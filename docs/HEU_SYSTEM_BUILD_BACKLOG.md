...
| P6-03 | TTGDTX audit-log coverage | IT/Data | PASS_LOCAL | New TTGDTX write tables need triggers; `components/audit/ttgdtx-audit-trail-guard.tsx`; audit trace acceptance matrix; `components/audit/ttgdtx-audit-log-uat-evidence-checklist.tsx`; `npm.cmd run audit:ttgdtx-audit-log`; `npm.cmd run audit:ttgdtx-audit-trail-guard`; signed UAT still required |
