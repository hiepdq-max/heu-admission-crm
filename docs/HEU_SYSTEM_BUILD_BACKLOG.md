...
| P3-02 | Lead-to-student handover | Tuyen sinh + CTHSSV + Dao tao | PASS_LOCAL | `docs/HEU_LEAD_TO_STUDENT_HANDOVER_POLICY_20260627.md`; `components/leads/lead-handover-panel.tsx`; P3-02 acceptance matrix and handover decision manifest; `npm.cmd run audit:heu-lead-handover-policy`; signed role-scope UAT and handover decision still required |
