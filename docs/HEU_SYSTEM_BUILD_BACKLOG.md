...
|---|---|---|---|---|
| P0-01 | Keep branch `hardening/ttgdtx-9plus-pilot` as working branch | IT/Data | IN_PROGRESS | No force push, no main/master push |
| P0-02 | Split dirty working tree by scope: docs, TTGDTX UI, TTGDTX SQL, CRM shared, audit scripts | IT/Data | OPEN | Review before commit |
