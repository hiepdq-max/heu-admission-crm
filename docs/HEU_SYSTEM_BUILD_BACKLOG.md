...
| P0-13 | Production blocker shared source | IT/Data + BGH + Audit | PASS_LOCAL | `lib/production-readiness.ts`; `npm.cmd run audit:heu-production-blocker-source`; blocker summary and production execution queue render from one source, including the P0-03 operator run sheet evidence path, P0-03 restore smoke-check proof for P0-19/P3 gate preservation, P0-09 owner sign-off/UAT handoff evidence path and P0-09 final owner decision manifest |
