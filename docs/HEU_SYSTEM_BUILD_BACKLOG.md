...
| P6-04 | Role-scope UAT | IT/Data + Process owners | PASS_LOCAL | `docs/HEU_ROLE_SCOPE_UAT_EXECUTION_PACK_20260627.md`; `components/settings/user-scope-enforcement-panel.tsx`; role-scope evidence checklist, route matrix and acceptance matrix; `npm.cmd run audit:heu-role-scope-uat-pack`; signed UAT still required |
