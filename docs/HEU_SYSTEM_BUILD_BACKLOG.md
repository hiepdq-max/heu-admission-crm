...
| P0-09 | Owner Go/No-Go sign-off pack | BGH + IT/Data + KHTC + PHAP_CHE + Audit | PASS_LOCAL | `docs/TTGDTX_PRODUCTION_OWNER_SIGNOFF_PACK_20260627.md`; `docs/TTGDTX_UAT_OPERATOR_HANDOFF_20260627.md`; `docs/HEU_NON_TTGDTX_CASCADE_FINDING_REGISTER_20260628.md`; `components/ttgdtx/ttgdtx-owner-go-no-go-evidence-checklist.tsx`; owner GO/NO-GO acceptance matrix; owner GO/NO-GO decision manifest; `npm.cmd run audit:ttgdtx-production-owner-signoff-pack`; owner GO/NO-GO still required |
