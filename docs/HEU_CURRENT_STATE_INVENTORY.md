...
| Process discovery/navigation | Shared TTGDTX process labels, Search suggestions, `/search` quick-open top 3 results with `data-heu-search-quick-open="P1-11_SEARCH_QUICK_OPEN"` and no-overflow guard, and `/ttgdtx` quick finder show business name before P2 code | PASS_LOCAL; signed browser UAT pending |
