...
| Hard-delete/cascade | TTGDTX cascade passes; non-TTGDTX review identifies 44 findings and exposes a conversion/waiver decision queue, hard-delete/cascade acceptance matrix and closure decision manifest | Conversion or written waiver pending |
