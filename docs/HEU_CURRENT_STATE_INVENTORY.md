...
| Data Master / Report View bridge | `/reports` shows compatibility objects, report-view master requirements and DQ-DM-01 through DQ-DM-04 stop conditions | PASS_LOCAL; no production SQL, source merge, real-data import, report-view signoff or dashboard reliance approved |
