...
| Hard-delete/cascade | TTGDTX cascade passes; non-TTGDTX review identifies 44 findings, locks P6-06-FIND-001 through P6-06-FIND-044 in `docs/HEU_NON_TTGDTX_CASCADE_FINDING_REGISTER_20260628.md`, and exposes a conversion/waiver decision queue, owner triage batch plan, batch 1 finance/legal/evidence closure checklist, hard-delete/cascade acceptance matrix and closure decision manifest | Conversion or written waiver pending |
