...
| P0-19 legal/finance gate ready | PHAP_CHE + KHTC | IN_PROGRESS | Legal and tuition gate evidence; `components/ttgdtx/ttgdtx-p019-gate-guard.tsx`; `npm.cmd run audit:ttgdtx-p019-gate-guard`; signed legal/finance UAT still required | YES | Receivable created without enough legal/finance basis |
