...
| AUD-TRACE-04 | Evidence link or controlled reference | Audit row aligns with `evidence_url`, source document or controlled evidence note | Evidence exposes passwords, temporary passwords, OTPs, password reset links, account activation/invite links, service-role keys, CCCD, bank accounts, raw student identity data, raw payment data or raw vouchers |
...
| P6-03-ACCEPT-05 | Redaction and owner sign-off | Screenshots/exports are redacted and signed by Audit, KHTC, IT_DATA, PHAP_CHE and BGH outside Codex/chat | Passwords, temporary passwords, OTPs, password reset links, account activation/invite links, service-role keys, raw student identity data, CCCD, bank accounts, raw payment data or raw vouchers appear |
