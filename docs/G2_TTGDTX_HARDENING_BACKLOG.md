...
|---|---|---:|---|---|---|
| Backup/rollback dry-run for Step90-Step110 | G2b/G2c | HIGH | `docs/STEP90_STEP110_BACKUP_ROLLBACK_DRY_RUN_RUNBOOK.md`; restore dry-run evidence | Tech Lead | IN_PROGRESS |
