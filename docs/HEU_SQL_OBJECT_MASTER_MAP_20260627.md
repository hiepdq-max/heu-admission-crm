...
| Step121 DCTC owner-assignee pair lock | `route_data_confirmation_task`, `owner_user_id`, `assigned_user_id`, `DCTC_OWNER_ASSIGNEE_PAIR_LOCK_READY`, `OWNER_AND_ASSIGNEE_REQUIRED_BEFORE_CHO_XAC_NHAN`, `RPC_ROUTE_TO_CHO_XAC_NHAN`, `CHO_XAC_NHAN` | `DATA_CONFIRMATION_OWNER_ASSIGNEE_LOCK`, `DATA_CONFIRMATION_TASK_MASTER`, `AUDIT_LOG` |
