...
requireText(
  inventory,
  /Role\/workspace scope[\s\S]*P6-04 pack, scope UI guard, evidence checklist, route matrix, acceptance matrix, internal UAT run closure tracker and execution-log closure template exist[\s\S]*Multi-account signed UAT pending/i,
