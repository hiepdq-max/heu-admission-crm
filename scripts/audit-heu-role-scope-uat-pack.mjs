...
requireText(pack, /(?=[\s\S]*data-heu-role-scope-access-decision-manifest="P6-04")(?=[\s\S]*P6-04-DEC-01)(?=[\s\S]*P6-04-DEC-06)(?=[\s\S]*P0-17 access closure decision)(?=[\s\S]*P6_04_ACCESS_READY \/ NO_GO \/ BLOCKED)(?=[\s\S]*missing P0-17 closure handoff)(?=[\s\S]*raw sensitive role-scope\s+evidence keeps P6-04 NO-GO)/i, "role-scope access decision manifest coverage");
