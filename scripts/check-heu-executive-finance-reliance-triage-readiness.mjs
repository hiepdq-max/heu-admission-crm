...
console.log("HEU executive finance reliance triage readiness check");
console.log(
...
requireText(
  ...
  "EXEC-DASHBOARD-STD26-FINANCE-RELIANCE-TRIAGE-ANCHOR",
  executiveDashboardPath,
);
requireAllText(
  executiveDashboard,
  triageTokens,
  "EXEC-DASHBOARD-STD26-FINANCE-RELIANCE-TRIAGE-TOKENS",
  executiveDashboardPath,
);
requireAllText(
  executiveReadiness,
...
if (
  packageJson.scripts?.["check:heu-executive-finance-reliance-triage-readiness"] !==
...
console.log(
  "HEU_EXECUTIVE_FINANCE_RELIANCE_TRIAGE_READY / NO_GO / BLOCKED: PASS_LOCAL_FINANCE_RELIANCE_TRIAGE with PASS_LOCAL_FINANCE_READONLY_RELIANCE_LOCK. This check verifies executive finance reliance triage and read-only reliance lock only; it does not clear debt, issue invoices, post vouchers, execute payment, issue bank instructions, approve finance reliance, accept UAT, accept evidence, approve owner GO/NO-GO or mark production GO.",
);
