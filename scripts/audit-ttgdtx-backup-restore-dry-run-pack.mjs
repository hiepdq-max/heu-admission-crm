...
if (!/P0-03[\s\S]*STEP90_STEP110_BACKUP_RESTORE_DRY_RUN_EVIDENCE_PACK_20260627\.md[\s\S]*components\/settings\/supabase-backup-restore-guard\.tsx[\s\S]*backup\/restore execution evidence checklist[\s\S]*restore smoke-check acceptance matrix[\s\S]*audit:ttgdtx-backup-restore-dry-run-pack/.test(backlog)) {
