...
requireText(
  "components/reports/report-view-source-map-panel.tsx",
  /(?=[\s\S]*data-heu-report-view-evidence-attachment-queue="RV-EVID-01)(?=[\s\S]*Evidence attachment queue)(?=[\s\S]*RV-EVID-01)(?=[\s\S]*P5-03-TRIAL-EVID-001 through P5-03-TRIAL-EVID-005)(?=[\s\S]*P5_03_CONTROLLED_TRIAL_READY \/ NO_GO \/ BLOCKED)(?=[\s\S]*RV-EVID-06)(?=[\s\S]*AUDIT_AI_SCOPE_READY \/ NO_GO \/ BLOCKED)(?=[\s\S]*does not upload files,\s+accept evidence or waive blockers)/i,
