...
requireText(
  "docs/HEU_SYSTEM_BUILD_BACKLOG.md",
  /P8-01[\s\S]*HOU ledger\/handover gap pack[\s\S]*PASS_LOCAL[\s\S]*HEU_HOU_LEDGER_HANDOVER_GAP_PACK_20260628_V01_DRAFT\.md[\s\S]*hou-ledger-handover-gap-pack\.tsx[\s\S]*\/hou[\s\S]*HOU-LH-01 through HOU-LH-08[\s\S]*audit:heu-hou-ledger-handover-gap-pack[\s\S]*does not approve HOU handover, tuition ledger posting, invoice issuance, COM payout, finance action, UAT acceptance, evidence acceptance, owner GO or production GO/i,
  "P8-01 backlog row",
);

requireText(
  "docs/TTGDTX_9PLUS_PILOT_PRODUCTION_CHECKLIST.md",
  /HOU ledger\/handover gap pack[\s\S]*PASS_LOCAL[\s\S]*HEU_HOU_LEDGER_HANDOVER_GAP_PACK_20260628_V01_DRAFT\.md[\s\S]*hou-ledger-handover-gap-pack\.tsx[\s\S]*\/hou[\s\S]*audit:heu-hou-ledger-handover-gap-pack[\s\S]*signed HOU handover UAT, tuition ledger proof, COM policy\/signoff and report-view owner signoff still required/i,
  "production checklist HOU gap-pack row",
);

requireText(
  "docs/HEU_CURRENT_STATE_INVENTORY.md",
  /npm\.cmd run audit:heu-hou-ledger-handover-gap-pack[\s\S]*PASS[\s\S]*HOU ledger\/handover gap pack[\s\S]*\/hou[\s\S]*HEU_HOU_LEDGER_HANDOVER_GAP_PACK_20260628_V01_DRAFT\.md[\s\S]*HOU-LH-01 through HOU-LH-08[\s\S]*PASS_LOCAL; no HOU handover, tuition ledger posting, invoice issuance, COM payout, finance action, UAT acceptance, evidence acceptance or production GO approved/i,
  "current-state HOU gap-pack evidence",
);

requireText(
  "docs/HEU_MODULE_READINESS_GAP_MATRIX_20260628_V01_DRAFT.md",
  /HOU Partnership Module[\s\S]*HEU_HOU_LEDGER_HANDOVER_GAP_PACK_20260628_V01_DRAFT\.md[\s\S]*HOU-LH-01 through HOU-LH-08[\s\S]*CAN_SUA[\s\S]*HOU handover UAT, HOU tuition ledger, HOU commission policy\/signoff[\s\S]*HOU ledger\/handover gap pack[\s\S]*hou-ledger-handover-gap-pack\.tsx[\s\S]*audit:heu-hou-ledger-handover-gap-pack/i,
...
requireText(
  "AGENTS.md",
  /Required Reading Before Meaningful Changes[\s\S]*docs\/HEU_HOU_LEDGER_HANDOVER_GAP_PACK_20260628_V01_DRAFT\.md[\s\S]*Before any final handoff[\s\S]*npm\.cmd run audit:heu-hou-ledger-handover-gap-pack/i,
  "AGENTS required reading and final handoff audit",
);

requireText(
  "scripts/audit-ttgdtx-release-gates.mjs",
  /docs\/HEU_HOU_LEDGER_HANDOVER_GAP_PACK_20260628_V01_DRAFT\.md[\s\S]*components\/hou\/hou-ledger-handover-gap-pack\.tsx[\s\S]*scripts\/audit-heu-hou-ledger-handover-gap-pack\.mjs[\s\S]*audit:heu-hou-ledger-handover-gap-pack/i,
