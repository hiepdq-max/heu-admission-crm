...
fastSection("2026-07-02 - REAL-OPS-01 Backup/Restore Proof Intake", [
  "HEU_REAL_OPS_01_BACKUP_RESTORE_PROOF_INTAKE_20260702.md",
  "PASS_LOCAL_PROOF_INTAKE",
  ...
  "REAL-OPS-01-IN-01 through REAL-OPS-01-IN-05",
...
fastSection("2026-07-02 - REAL-OPS-02 Signed Migration Order Intake", [
  "HEU_REAL_OPS_02_SIGNED_MIGRATION_ORDER_INTAKE_20260702.md",
  "PASS_LOCAL_SIGNOFF_INTAKE",
  "REAL_OPS_02_MIGRATION_ORDER_READY / NO_GO / BLOCKED",
  "supabase-backup-restore-guard.tsx",
  "data-p003-real-ops-02-migration-order-intake=\"REAL-OPS-02_P0-03\"",
  "REAL-OPS-02-IN-01 through REAL-OPS-02-IN-05",
  "backup/restore prerequisite",
  "signer authority",
  "Step90-Step110 scope",
  "exception/rollback decision",
  "migration-order decision",
  "STEP90_STEP110_MIGRATION_ORDER_SIGNOFF_GUARD_20260627.md",
  "HEU_REAL_OPERATION_CLOSURE_PLAN_20260702.md",
  "HEU_SYSTEM_BUILD_BACKLOG.md",
  "TTGDTX_9PLUS_PILOT_PRODUCTION_CHECKLIST.md",
  ...
  "audit-heu-implementation-log.mjs",
  "audit-ttgdtx-release-gates.mjs",
  "does not sign the migration order",
...
fastSection("2026-07-02 - REAL-OPS-03 Signed UAT Closure Intake", [
  "HEU_REAL_OPS_03_SIGNED_UAT_CLOSURE_INTAKE_20260702.md",
  "PASS_LOCAL_UAT_CLOSURE_INTAKE",
  ...
  "REAL-OPS-03-UAT-01 through REAL-OPS-03-UAT-06",
  "route result index",
  "owner signatures",
  "finance reliance routes",
  "governance routes",
  "exception/NO-GO handling",
...
fastSection("2026-07-02 - REAL-OPS-04 Finance Reliance Closure Intake", [
  "HEU_REAL_OPS_04_FINANCE_RELIANCE_CLOSURE_INTAKE_20260702.md",
  "PASS_LOCAL_FINANCE_RELIANCE_INTAKE",
  "REAL_OPS_04_FINANCE_RELIANCE_READY / NO_GO / BLOCKED",
  "production-readiness-blocker-summary.tsx",
  "data-heu-real-ops-04-finance-reliance-intake=\"REAL-OPS-04_FINANCE\"",
  "REAL-OPS-04-FIN-01 through REAL-OPS-04-FIN-06",
  "P2-18/P5-03 source reconciliation",
...
fastSection("2026-07-02 - REAL-OPS-05 Legal Invoice Chung-Tu Confirmation Intake", [
  "HEU_REAL_OPS_05_LEGAL_INVOICE_CHUNGTU_CONFIRMATION_INTAKE_20260702.md",
  "PASS_LOCAL_LEGAL_INVOICE_INTAKE",
  "REAL_OPS_05_LEGAL_INVOICE_READY / NO_GO / BLOCKED",
  "production-readiness-blocker-summary.tsx",
  "data-heu-real-ops-05-legal-invoice-intake=\"REAL-OPS-05_LEGAL_INVOICE\"",
  "REAL-OPS-05-LEG-01 through REAL-OPS-05-LEG-06",
  "P0-19 legal gate",
  "P2-01 contract/SOP basis",
  "P2-02 tuition policy",
  "P2-10 invoice/chung-tu",
...
fastSection("2026-07-02 - P7-06 Cloud Agent Operating Plan", [
  "HEU_CLOUD_AGENT_OPERATING_PLAN_20260702.md",
  "PASS_LOCAL_PLAN",
  "CLOUD_AGENT_PLAN_READY / NO_GO / BLOCKED",
  "USD 20-40",
  "human owner setup checklist",
  "kill switch",
  "operating loop",
  "stop conditions",
  "HEU_AI_ASSISTANT_POLICY_20260627.md",
...
fastSection("2026-07-02 - P5-02 Department Task Handoff Register Dry-Run", [
  ...
  "BGH, IT_DATA, KHTC",
  "PHAP_CHE, Audit, TUYEN_SINH, CTHSSV, DAO_TAO and HR",
  "department",
  "user labels",
  "stage",
  "in-app task",
...
fastSection("2026-07-02 - P5-02 Daily Email Dispatch Handoff Guard", [
  "HEU_DAILY_EMAIL_DISPATCH_HANDOFF_20260702.md",
  "PASS_LOCAL_CONFIG_HANDOFF",
  "EMAIL_DISPATCH_HANDOFF_READY / EMAIL_CONFIG_REQUIRED / BLOCKED",
  "scripts/report-heu-email-readiness.mjs",
  "required approval owners",
  "allowed recipient labels",
  "manual enablement",
  "stop conditions",
  "recipient addresses",
  "SMTP values",
...
fastSection("2026-07-02 - Master Control Goal Register", [
  "HEU_MASTER_CONTROL_GOAL_REGISTER_20260702.md",
  "PASS_LOCAL_GOAL_CONTROL",
  "MASTER_GOAL_READY / NO_GO / BLOCKED",
  "continuous cloud PASS_LOCAL",
...
fastSection("2026-07-02 - P5-02 Master Goal Daily Report Summary", [
  "scripts/report-heu-daily-dry-run.mjs",
  "HEU_MASTER_CONTROL_GOAL_REGISTER_20260702.md",
  "MASTER_GOAL_READY / NO_GO / BLOCKED",
  "phase order A-E",
  "cloud PASS_LOCAL boundary",
  "local machine is off",
  "expert-team lanes",
  "BGH, IT_DATA, KHTC, PHAP_CHE, Audit",
  "HEU_BGH_OPERATING_DASHBOARD_SPEC_20260627.md",
  "HEU_SYSTEM_BUILD_BACKLOG.md",
  "TTGDTX_9PLUS_PILOT_PRODUCTION_CHECKLIST.md",
  "HEU_CURRENT_STATE_INVENTORY.md",
...
fastSection("2026-07-02 - P5-02 Daily Report Blocker Owner Lanes", [
  "scripts/report-heu-daily-dry-run.mjs",
  "lib/production-readiness.ts",
  "PRODUCTION_BLOCKERS",
  "BLOCKER_OWNER_LANES_READY / NO_GO / BLOCKED",
  "P0-03",
  "Step90-Step110",
  "P0-19",
  "P2-17",
  ...
  "P0-10",
  "P0-09",
  "IT_DATA, KHTC, PHAP_CHE, BGH, Audit",
  "TRUONG_PHONG",
  "business owners",
  "HEU_BGH_OPERATING_DASHBOARD_SPEC_20260627.md",
  "HEU_SYSTEM_BUILD_BACKLOG.md",
...
fastSection("2026-07-02 - P5-02 Daily Report Signed UAT Route Summary", [
  "scripts/report-heu-daily-dry-run.mjs",
  "TTGDTX_UAT_EXECUTION_LOG_20260625.md",
  "Section 5.2",
  "TTGDTX_SIGNED_UAT_EXECUTION_ROUTING_HUB_20260628.md",
  "SIGNED_UAT_ROUTE_SUMMARY_READY / NO_GO / BLOCKED",
...
fastSection("2026-07-02 - P5-02 In-App Signed UAT Route Summary", [
  "production-readiness-blocker-summary.tsx",
...
fastSection("2026-07-02 - P5-02 Authority Information Request Guard", [
  "scripts/report-heu-daily-dry-run.mjs",
  "INFO_REQUIRED_BY_AUTHORITY / NO_GO / BLOCKED",
  "unclear inputs",
  "right authority",
  "data-heu-authority-information-requests=\"P5-02\"",
  "production-readiness-blocker-summary.tsx",
  "INFO-REQ-01 through INFO-REQ-06",
  "BGH, IT_DATA, KHTC",
  "PHAP_CHE",
  "Audit",
  "TRUONG_PHONG",
...
fastSection("2026-07-02 - Finance Desk Day-1 Accountant Handoff", [
  "finance-day-one-accountant-handoff.tsx",
  "/finance-desk",
