...
const systemAiTrendTaskBreakdown = read(
  "docs/HEU_SYSTEM_AI_TREND_ANTI_OVERFLOW_TASK_BREAKDOWN_20260703.md",
);
...
fastRequire(
  systemAiTrendTaskBreakdown,
  [
    "Status: PASS_LOCAL_PLAN",
    "Decision values: SYSTEM_AI_TREND_TASK_READY / NO_GO / BLOCKED",
    "Production status: NO-GO",
    "GOAL-00 System Snapshot Only",
    "GOAL-01 AI Control Baseline",
    "GOAL-02 Anti-Overflow Inventory",
    "GOAL-03 One-Slice Selection",
    "GOAL-04 Verification Gate",
    "OpenAI Agents SDK",
    ...
    "overflow-x-auto",
    "aria-label",
    "no production, UAT, evidence, finance or owner GO approval",
    "Production remains NO-GO",
  ],
  "system AI trend anti-overflow task breakdown",
  "docs/HEU_SYSTEM_AI_TREND_ANTI_OVERFLOW_TASK_BREAKDOWN_20260703.md",
);

fastSection("2026-07-03 - System AI Trend Anti-Overflow Task Breakdown", [
  "HEU_SYSTEM_AI_TREND_ANTI_OVERFLOW_TASK_BREAKDOWN_20260703.md",
  "PASS_LOCAL_PLAN",
  "`GOAL-00` through `GOAL-04`",
  "OpenAI Agents SDK",
  "guardrails/human review",
  "Claude Code hooks",
  "subagents",
  ...
  "scope/context overflow",
  "one-slice",
  "dirty-target diff checks",
  "no raw data",
  "scripts/audit-heu-ai-policy.mjs",
  "scripts/audit-heu-implementation-log.mjs",
  "SYSTEM_AI_TREND_TASK_READY / NO_GO / BLOCKED",
  "does not add AI service calls",
  "model credentials",
  "prompt storage",
  "autonomous workers",
  "app runtime",
...
fastSection("2026-07-03 - P0-14 Documents To Lead Filter Guard", [
  ...
  "normalizeLeadQuickFilter",
  "initialQuickFilter",
  'data-heu-lead-list-initial-quick-filter="P0-05_LEAD_LIST_INITIAL_QUICK_FILTER"',
  "document-status lead group",
  "scripts/audit-heu-data-foundation.mjs",
  "scripts/audit-heu-implementation-log.mjs",
  "documents-to-lead filter",
  "fails locally",
  "PASS_LOCAL boundary",
  "read-only documents-to-lead navigation/filter",
  "does not",
...
fastSection("2026-07-03 - P0-05 Lead Create Workspace Guard", [
  ...
  'withAdmissionSegmentParam("/leads", admissionSegmentId)',
  "can_use_admission_workspace",
  "segment-scope checks",
  "scripts/audit-heu-data-foundation.mjs",
  "PASS_LOCAL boundary",
  "create-lead navigation",
...
fastSection("2026-07-03 - P0-05 Lead Workspace Deep-Link Guard", [
  "components/leads/lead-list.tsx",
  "withAdmissionSegmentParam",
  "leadHref",
  "app/leads/page.tsx",
...
fastSection("2026-07-03 - P0-05 Lead Activity Follow-up Workspace Revalidation Guard", [
  "components/leads/activity-form.tsx",
  "active_admission_segment_id",
  ...
  "scripts/audit-heu-data-foundation.mjs",
  "scripts/audit-heu-implementation-log.mjs",
  "activity form marker",
  "hidden workspace field",
  "page prop flow",
  "scoped follow-up/pipeline",
  "PASS_LOCAL boundary",
  "lead activity follow-up workspace revalidation",
  "does not grant access",
  "change role scope",
  "bypass P0-19",
  "real lead activity submission",
  "create lead records",
  "execute UAT",
  "accept evidence",
  "approve finance action",
...
fastSection("2026-07-03 - P0-05 Lead Condition Workspace Return Guard", [
  ...
  "scoped detail revalidation",
  "PASS_LOCAL boundary",
  "condition checklist workspace-return",
  "does not grant access",
  "change role scope",
  "bypass P0-19",
  "accept evidence",
...
fastSection("2026-07-03 - P8-01 HOU Scope Readiness Guard", [
  "app/hou/page.tsx",
  ...
  "payment-batch",
  "app/hou/actions.ts",
  "getHouClaimsWorkspaceScopeError",
  "getHouClaimLinesWorkspaceScopeError",
  "can_use_admission_workspace",
  "can_access_business_scope",
  "scripts/check-heu-hou-scope-readiness.mjs",
  "check:heu-hou-scope-readiness",
  "HOU-SCOPE-APP-GUARD",
  "HOU-SCOPE-LEAD-TAG",
  ...
  "PASS_LOCAL boundary",
  "HOU scope-readiness hardening only",
  "does not approve HOU handover",
  "tuition ledger posting",
  "invoice issuance",
  "COM payout",
  "finance action",
  "UAT acceptance",
...
fastSection("2026-07-03 - P0-14 Import Quick Access Guard", [
  "components/import/lead-import-form.tsx",
...
fastSection("2026-07-02 - P5-02 Daily Report Real Ops Route Summary", [
  ...
  "approve owner GO/NO-GO",
  "mark production GO",
  "REAL-OPS-01 backup/restore proof",
  "REAL-OPS-02 signed migration",
  "REAL-OPS-03 signed UAT closure",
  "REAL-OPS-04 finance reliance closure",
  "REAL-OPS-05 legal/invoice/chung-tu confirmation",
  "REAL-OPS-06",
  "hard-delete/cascade closure",
  "REAL-OPS-07 HOU and Short Course scope",
...
fastSection("2026-07-02 - REAL-OPS-06 Hard-Delete Cascade Closure Intake", [
  "HEU_REAL_OPS_06_HARD_DELETE_CASCADE_CLOSURE_INTAKE_20260702.md",
  "PASS_LOCAL_CASCADE_CLOSURE_INTAKE",
  "REAL_OPS_06_CASCADE_CLOSURE_READY / NO_GO / BLOCKED",
  "production-readiness-blocker-summary.tsx",
  "data-heu-real-ops-06-cascade-closure-intake=\"REAL-OPS-06_CASCADE\"",
  "REAL-OPS-06-HDQ-01 through REAL-OPS-06-HDQ-06",
  "P6-06 current finding register",
  "protected-record conversion route",
  "derived-helper waiver route",
  "rollback and redaction route",
  "batch closure",
  "authority decision path",
  "HEU_REAL_OPERATION_CLOSURE_PLAN_20260702.md",
  "HEU_SYSTEM_BUILD_BACKLOG.md",
  ...
  "audit-heu-bgh-dashboard-spec.mjs",
  "audit-heu-implementation-log.mjs",
  "does not approve production deletion",
  "cascade execution",
  "waiver",
...
fastSection("2026-07-02 - REAL-OPS-07 HOU Short Course Scope Intake", [
  "HEU_REAL_OPS_07_HOU_SHORT_COURSE_SCOPE_INTAKE_20260702.md",
  "PASS_LOCAL_SCOPE_SEPARATION_INTAKE",
  "REAL_OPS_07_SCOPE_READY / NO_GO / BLOCKED",
  "production-readiness-blocker-summary.tsx",
  "data-heu-real-ops-07-hou-short-course-scope-intake=\"REAL-OPS-07_HOU_SHORT_COURSE\"",
  "REAL-OPS-07-SCOPE-01 through REAL-OPS-07-SCOPE-06",
  "HOU gap pack",
  "HOU phase decision route",
  "Short Course gap pack",
  "Short Course phase decision route",
  "TTGDTX separation",
  "authority decision path",
  "HEU_REAL_OPERATION_CLOSURE_PLAN_20260702.md",
  "HEU_SYSTEM_BUILD_BACKLOG.md",
...
fastSection("2026-07-02 - REAL-OPS-08 Final Owner GO/NO-GO Intake", [
  "HEU_REAL_OPS_08_FINAL_OWNER_GONOGO_INTAKE_20260702.md",
  ...
  "REAL-OPS-08-OWNER-01 through REAL-OPS-08-OWNER-06",
  "prerequisite closure index",
  "evidence redaction and storage",
  "UAT and finance reliance package",
  "migration and risk package",
  "owner quorum",
  ...
  "owner GO/NO-GO",
  "production GO",
  "REAL-OPS-01 through REAL-OPS-07",
  "P0-10 redaction acceptance",
  "P0-14 evidence binder",
