...
requireTokens(
  ...
  [
    ...
    "active users in the task `department_code`",
...
console.log(
  "dctc_owner_assignee_department_match=DCTC_OWNER_ASSIGNEE_DEPARTMENT_MATCH_READY|OWNER_ASSIGNEE_MUST_MATCH_TASK_DEPARTMENT",
);
console.log(
