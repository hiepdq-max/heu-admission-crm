...
const requiredBlueprintTokens = [
  ...
  "role-only fallback is",
  "Daily administration must use a separate positioned `IT_DATA` operating",
  "remain Auth-banned and its",
  "dedicated break-glass position and least-privilege matrix",
  "Owner + IT_DATA + Audit",
  "only valid decision is `BLOCKED`",
  ...
  "Personalized context is `no-store`",
  "Do not retry",
  "inside the request. Timeout",
  "reject payloads over 8 KiB",
  "Mandatory negative test matrix",
  "candidate grants any permission denied by the old result",
  "two different users in the same process",
  "must not contain raw user ID",
