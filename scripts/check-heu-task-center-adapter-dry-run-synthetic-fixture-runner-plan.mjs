...
if (failures.length === 0) {
  ...
  requireTokens(
    ...
    [
      ...
      "TaskCenterAdapterDryRunSyntheticFixtureRunnerPlanItem",
      "adapterDryRunSyntheticFixtureRunnerPlanItems",
      ...
      "RUNNER_PLAN_LOAD_STATIC_CONTRACT",
      "RUNNER_PLAN_VALIDATE_SCOPE_ASSERTIONS",
      "RUNNER_PLAN_VALIDATE_RESTRICTED_FIELDS",
      "RUNNER_PLAN_VALIDATE_DEPARTMENT_MISMATCH",
      "RUNNER_PLAN_REPORT_PASS_NO_GO_ONLY",
      "PLAN_STEP_LOAD_SYNTHETIC_CONTRACT_METADATA",
      "PLAN_STEP_VALIDATE_SCOPE_ASSERTIONS",
      "PLAN_STEP_VALIDATE_RESTRICTED_FIELD_ALLOWLIST",
      "PLAN_STEP_VALIDATE_DEPARTMENT_MISMATCH",
      "PLAN_STEP_REPORT_PASS_NO_GO_WITHOUT_APPROVAL",
      "SYNTHETIC_FIXTURE_CONTRACT_READY",
      "SYN_ACTOR_AND_TASK_METADATA_ONLY",
      "SYN_TASK_RESTRICTED_FIELDS_MASKED",
      "SYN_ACTOR_DEPARTMENT_A_TO_TASK_DEPARTMENT_B",
      "LOCAL_ASSERTION_RESULTS_ONLY",
      "IN_MEMORY_FIXTURE_PLAN_ONLY",
      "LOCAL_PASS_NO_GO_SCOPE_REPORT_ONLY",
      "LOCAL_RESTRICTED_FIELD_REPORT_ONLY",
      "LOCAL_DEPARTMENT_MISMATCH_REPORT_ONLY",
      "LOCAL_PASS_NO_GO_REPORT_ONLY",
    ...
    "synthetic fixture runner plan source token",
    panelSourcePath,
  );
  ...
  requireTokens(
    ...
    [
      ...
      "TASK_CENTER_ADAPTER_DRY_RUN_SYNTHETIC_FIXTURE_RUNNER_PLAN_NO_REAL_DATA",
      "TASK_CENTER_ADAPTER_DRY_RUN_SYNTHETIC_FIXTURE_RUNNER_PLAN_NO_AI_OR_AUTOMATION",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-readonly",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-draft-only",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-no-approval",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-no-database-read",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-no-database-client",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-no-env-enablement",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-no-task-mutation",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-no-real-data",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-no-ai-or-automation",
      "data-heu-task-center-adapter-dry-run-synthetic-fixture-runner-plan-item",
    ...
    "component synthetic fixture runner plan token",
    componentPath,
  );
  ...
  requireTokens(
    ...
    "synthetic fixture contract next-slice token",
    syntheticFixtureContractDocPath,
  );
  ...
  requireTokens(
    ...
    [
      ...
      "TASK_CENTER_DATABASE_READY: NO_GO_SYNTHETIC_FIXTURE_RUNNER_PLAN_ONLY",
      "NO_RUNTIME_MUTATION: task center adapter dry-run synthetic fixture runner plan checker only; no owner approval, database client, database read, env enablement, runtime fixture file, runtime runner file, table creation, SQL migration, task write, file upload, storage write, real-data fixture, AI call, paid automation, deploy, finance action or production GO",
    ],
  ...
  forbidPatterns(
    ...
    "task-center adapter dry-run synthetic fixture runner plan scope",
  );
...
if (failures.length > 0) {
  console.error(
    "HEU Task Center adapter dry-run synthetic fixture runner plan check failed:",
  );
...
console.log("HEU Task Center adapter dry-run synthetic fixture runner plan check");
console.log(
  "HEU_TASK_CENTER_ADAPTER_DRY_RUN_SYNTHETIC_FIXTURE_RUNNER_PLAN_READY: PASS_LOCAL",
);
console.log(
