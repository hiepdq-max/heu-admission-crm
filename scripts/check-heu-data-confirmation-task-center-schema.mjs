...
requireTokens(
  ...
  [
    ...
    "public.dctc_user_matches_department",
    ...
    "Owner and assigned users must match the data-confirmation department",
    "public.dctc_user_matches_department(p_owner_user_id, cleaned_department_code)",
    "public.dctc_user_matches_department(p_assigned_user_id, cleaned_department_code)",
    "DCTC_RPC_ONLY_MUTATION_LOCK_READY",
    "NO_DIRECT_TABLE_UPDATE",
    "NO_DIRECT_STATUS_HISTORY_INSERT",
...
console.log(
  "owner_assignee_department_match=DCTC_OWNER_ASSIGNEE_DEPARTMENT_MATCH_READY; route_requires=OWNER_ASSIGNEE_MUST_MATCH_TASK_DEPARTMENT",
);
console.log(
